...
<!--                <img :src="item" alt="" style="width: 900px">-->
<!--              </el-carousel-item>-->
<!--            </el-carousel>-->
<!--          </div>-->
<!--        </el-col>-->
...
<!--          &lt;!&ndash;          <el-col :span="6"><el-button label="content-0" name="third" :class="{active: active===1}" @click="jump('aaa')" >Overview</el-button></el-col>&ndash;&gt;-->
<!--          &lt;!&ndash;          <el-col :span="6"><el-button label="content-1" name="third" :class="{active: active===2}" @click="jump('bbb')">Amenities</el-button></el-col>&ndash;&gt;-->
<!--          &lt;!&ndash;          <el-col :span="6"><el-button label="content-2" name="third" :class="{active: active===3}" @click="jump('ccc')">Reviews</el-button></el-col>&ndash;&gt;-->
<!--          &lt;!&ndash;          <el-col :span="6"><el-button label="content-3" name="third" :class="{active: active===4}" @click="jump('ddd')">Map</el-button></el-col>&ndash;&gt;-->
...
<!--                  <el-col :span="12" align="left"><i :class="occuam[2*item-2].classname"><span > {{occuam[2*item-2].name}}</span></i></el-col>-->
...
<!--                </div>-->
<!--&lt;!&ndash;                <el-row>&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-col :span="12" align="left"><i class="iconicon-test1" style="font-size: 25px"><span v-if="show_amentities('TV')"> television</span><span v-else><del> television</del></span></i></el-col>&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-col :span="12" align="left"><i class="el-icon-thirdgarage" style="font-size: 25px"><span v-if="show_amentities('Garage')"> Garage</span><span v-else><del> Garage</del></span></i></el-col>&ndash;&gt;-->
<!--&lt;!&ndash;                </el-row>&ndash;&gt;-->
<!--&lt;!&ndash;                <el-row>&ndash;&gt;-->
...
<!--&lt;!&ndash;        <property-list></property-list>&ndash;&gt;-->
<!--        <related></related>-->
<!--      </el-main>-->
<!--    </el-container>-->
<!--  </div>-->
...
<!--    return {-->
<!--      listamen: [-->
<!--        {classname: 'iconicon-test1', name: 'TV'},-->
<!--        {classname: 'el-icon-thirdgarage', name: 'Garage'},-->
...
<!--        {classname: 'el-icon-thirdairconditioning', name: 'Microwave'},-->
...
<!--      }-->
<!--      this.listshow = this.word_list.sort(function (a, b) { return b['context'].length - a['context'].length })-->
<!--    },-->
<!--    check_len (item) {-->
...
<!--    getNearby () {-->
<!--      this.$axios-->
<!--        .get('/api/nearby_propert?property=' + this.property)-->
<!--        .then(res => {-->
<!--          this.title = res.data.body.title-->
<!--          this.description = res.data.body.description-->
<!--          this.guests = res.data.body.guests-->
...
<!--                          </el-main>-->
                    ...
                    <template v-else>
                      ...
                      <div class="showBg">
                        ...
                        <!--                            <el-row v-for="item in this.word_list" :key="item">-->
                        <!--                              {{item['context']}}-->
                        <!--                            </el-row>-->
                        <!--                            <main>{{ content }}</main>-->
                        <div class="hideBtn">
